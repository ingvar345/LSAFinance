...
namespace Billing_Module
{
    public partial class Cashiering2 : Form
    {
        ...
        void insertupdatebill()
        {
            ...
            decimal kinderval = Decimal.TryParse(advance.Text, out kinderval) ? kinderval : 0;
            decimal gradeschoolval = Decimal.TryParse(advance.Text, out gradeschoolval) ? gradeschoolval : 0;
            decimal highschoolval = Decimal.TryParse(advance.Text, out highschoolval) ? highschoolval : 0;
            decimal seniorhsval = Decimal.TryParse(advance.Text, out seniorhsval) ? seniorhsval : 0;
            decimal nighthsval = Decimal.TryParse(advance.Text, out nighthsval) ? nighthsval : 0;
            decimal othersval = Decimal.TryParse(advance.Text, out othersval) ? othersval : 0;
